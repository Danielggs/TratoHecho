...
public class UsuarioController {
    ...
    @GetMapping("")
    public String usuario(HttpSession httpSession, ModelMap modelo) {
        
        Usuario usuario = (Usuario) httpSession.getAttribute("usuario");

        List<Contratacion> listarContrataciones = contratacionServicio.buscarContratacionId(usuario.getId());
        
        List<Usuario> trabajadores = new ArrayList<>();
        
        for (Contratacion contratacion : listarContrataciones) {
            Usuario trabajador = usuarioServicio.buscarUId(contratacion.getTrabajador().getId());
    ...
    public String contratacion(@RequestParam("idTrabajador") String idTrabajador,
     ...
     @GetMapping("/eliminar")
    public String eliminar(@RequestParam("idTrabajador") String idTrabajador,
            Principal principal,
            RedirectAttributes redirectAttributes,
            HttpSession httpSession,
            ModelMap modelo) {
        ...
        try {
            ...
            Usuario usuario = (Usuario) httpSession.getAttribute("usuario");
            contratacionServicio.eliminarContratacion(usuario.getId(), idTrabajador);
